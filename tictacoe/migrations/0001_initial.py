    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_to_move', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games_to_move', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Move',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tictacoe.Game')),
            ],
        ),
    ]
